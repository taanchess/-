...
<body>
    ...
    <input type="number" id="n" placeholder=" Введите n" style="border-radius: 10px;">
    <br>
    <br>
    ...
    <br>
    <br>
    <button onclick="calculate()" style="width: 214px; height: 41px; border-radius: 35px; background: #E7410D; color: white; font-size: 16px;">Рассчитать выгоду</button>
    <br>
    <br>
    <p>ВЫГОДА: <span id="result"></span></p>

    <br>
    <button onclick="leaveRequest()" style="width: 214px; height: 41px; border-radius: 35px; border: 1px solid #E7410D; background: transparent; color: #E7410D; font-size: 16px;">Оставить заявку</button>
